...
CMAKE_ALIGN_SYSROOT[2] = "PolkitQt5-1, -S${includedir}, -s${KDE_PATH_HOST_HEADERS}"
CMAKE_ALIGN_SYSROOT[3] = "PolkitQt5-1, -s${PACKAGE_PREFIX_DIR}/include, -s${KDE_PATH_HOST_HEADERS}"
